<template>
  <div class="vdp-datepicker" :class="wrapperClass">
    <div class="vdp-datepicker__group" :class="{'input-group' : bootstrapStyling}">
...
<script>
  ...
  define([
  'Vue',
  'dir_helpers/DateUtils',
  'dir_helpers/DateLanguages',
  ], function(Vue, DateUtils, DateLanguages) {

    return Vue.component('datepicker', {
      template: template,
      props: {
        value: {
